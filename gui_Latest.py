...
def Weight_Loss():
    ...
    print("Max index in LunchfoodseparatedID:", max(LunchfoodseparatedID))
    ...
    breakfastfoodseparatedIDdata=breakfastfoodseparatedIDdata.T
    print("Length of DataFrame:", len(data))
    print("Max index in breakfastfoodseparatedID:", max(breakfastfoodseparatedID))
    ...
    DinnerfoodseparatedIDdata=DinnerfoodseparatedIDdata.T
    print("Length of DataFrame:", len(data))
    print("Max index in DinnerfoodseparatedID:", max(DinnerfoodseparatedID))
    ...
    Datacalorie=DinnerfoodseparatedIDdata[1:,1:len(DinnerfoodseparatedIDdata[0])-1]
    ...
    Datacalorie=LunchfoodseparatedIDdata[1:,1:len(LunchfoodseparatedIDdata[0])-1]
    X = np.array(Datacalorie)
    kmeans = KMeans(n_clusters=3, random_state=0).fit(X)
    XValu=np.arange(0,len(kmeans.labels_))
    ...
    Datacalorie=breakfastfoodseparatedIDdata[1:,1:len(breakfastfoodseparatedIDdata[0])-1]
    X = np.array(Datacalorie)
    kmeans = KMeans(n_clusters=3, random_state=0).fit(X)
    XValu=np.arange(0,len(kmeans.labels_))
...
main_win.geometry("800x380")  # Adjusted the height for the new dropdown


# Labels
Label(main_win, text="Age", font='Helvetica 12 bold').grid(row=1, column=0, sticky=W, pady=8)
Label(main_win, text="Weight", font='Helvetica 12 bold').grid(row=2, column=0, sticky=W, pady=8)
Label(main_win, text="Height", font='Helvetica 12 bold').grid(row=3, column=0, sticky=W, pady=8)
Label(main_win, text="Diabetic", font='Helvetica 12 bold').grid(row=4, column=0, sticky=W, pady=8)
...
diabetic_var = StringVar()
diabetic_combobox = ttk.Combobox(main_win, textvariable=diabetic_var, values=["Yes", "No"])
diabetic_combobox.grid(row=4, column=1)
diabetic_combobox.set("No")  # Set the default value to "No"



result_text = Text(main_win, wrap=WORD, state="disabled", height=5, width=30)
result_text.grid(row=6, columnspan=4)
# Buttons
Button(main_win, text='Quit', font='Helvetica 8 bold', command=main_win.quit).grid(row=8, column=0, sticky=W, pady=8)
Button(main_win, text='Weight Loss', font='Helvetica 8 bold', command=Weight_Loss).grid(row=1, column=7, sticky=W, pady=8)
Button(main_win, text='Weight Gain', font='Helvetica 8 bold', command=Weight_Gain).grid(row=2, column=7, sticky=W, pady=8)
Button(main_win, text='Healthy', font='Helvetica 8 bold', command=Healthy).grid(row=3, column=7, sticky=W, pady=7)
